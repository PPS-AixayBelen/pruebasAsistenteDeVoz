...
//Servidor MQTT
const char* mqtt_server = "ays10q775afsj-ats.iot.us-east-1.amazonaws.com";
...
void loop() {
  ...
  //No mover esta linea pa abajo plis
  client.subscribe("algo");      
  client.loop();   
